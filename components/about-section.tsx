        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <div className="relative">
              <div className="aspect-4/3 rounded-2xl overflow-hidden shadow-2xl">
                <Image width={400} quality={100} height={400} src="/travel-agency-professional-team-meeting-office.jpg" alt="Our Team" className="w-full h-full object-cover" />
              </div>
              {/* Floating Card */}
          ...
          >
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-8">
              Since 2023, Mumo Travels & Tours has been helping travelers explore the world with confidence. We combine
